...
- [HTTPS And CA Handling](documents/https-and-ca.md): CONNECT interception, disk or memory certificate storage, supplied root CA material, generated CA trust, and upstream TLS agents.
